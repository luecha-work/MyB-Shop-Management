...
- `app/(dashboard)/branches/page.tsx`: Manage-branch page with table, add-branch modal, and delete selected branches. Success/error operation feedback uses floating antd `Alert` components at the top-right under the app header and auto-dismisses.
