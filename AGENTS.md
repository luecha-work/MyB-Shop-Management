...
- `app/(dashboard)/users/page.tsx`: Manage-user page with table, add-user modal, reset-password confirm modal, copy temporary-password modal, and delete selected users. Users cannot delete themselves.
